  ...
  return (
    <BottomSheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed left-0 right-0 bottom-0 z-50 h-[95vh] flex flex-col border-t bg-background rounded-t-3xl shadow-lg duration-200",
      ...
      >
        {/* Drag handle */}
        <div 
          className="sticky top-0 z-10 flex justify-between items-center pt-4 pb-2 px-2 bg-background rounded-t-3xl shrink-0"
          {...swipeProps}
        >
        ...
        <div className="overflow-y-auto overscroll-contain flex-1 px-2 pb-6 safe-area-pb -webkit-overflow-scrolling-touch">
          {children}
        </div>
      </DialogPrimitive.Content>
    </BottomSheetPortal>
