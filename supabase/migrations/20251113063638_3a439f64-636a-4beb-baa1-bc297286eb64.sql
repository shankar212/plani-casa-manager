...
-- Drop existing project_shares policies
...
-- Drop existing account_shares policies
DROP POLICY IF EXISTS "Users can view their account shares" ON public.account_shares;
DROP POLICY IF EXISTS "Account owners can create shares" ON public.account_shares;
DROP POLICY IF EXISTS "Account owners can delete shares" ON public.account_shares;
DROP POLICY IF EXISTS "Account owners can update shares" ON public.account_shares;
...
DROP POLICY IF EXISTS "Users can create stages for accessible projects" ON public.project_stages;
DROP POLICY IF EXISTS "Users can update stages of accessible projects" ON public.project_stages;
DROP POLICY IF EXISTS "Users can delete stages of accessible projects" ON public.project_stages;
...
DROP POLICY IF EXISTS "Users can create tasks for accessible projects" ON public.project_tasks;
DROP POLICY IF EXISTS "Users can update tasks of accessible projects" ON public.project_tasks;
DROP POLICY IF EXISTS "Users can delete tasks of accessible projects" ON public.project_tasks;
...
DROP POLICY IF EXISTS "Users can view materials of accessible projects" ON public.materials;
DROP POLICY IF EXISTS "Users can create materials for accessible projects" ON public.materials;
DROP POLICY IF EXISTS "Users can update materials of accessible projects" ON public.materials;
DROP POLICY IF EXISTS "Users can delete materials of accessible projects" ON public.materials;
...
DROP POLICY IF EXISTS "Users can view follow-up notes of accessible projects" ON public.follow_up_notes;
DROP POLICY IF EXISTS "Users can create follow-up notes for accessible projects" ON public.follow_up_notes;
DROP POLICY IF EXISTS "Users can update follow-up notes of accessible projects" ON public.follow_up_notes;
DROP POLICY IF EXISTS "Users can delete follow-up notes of accessible projects" ON public.follow_up_notes;
...
-- Update legal_documents policies
...
DROP POLICY IF EXISTS "Users can view legal documents of accessible projects" ON public.legal_documents;
DROP POLICY IF EXISTS "Users can create legal documents for accessible projects" ON public.legal_documents;
DROP POLICY IF EXISTS "Users can update legal documents of accessible projects" ON public.legal_documents;
DROP POLICY IF EXISTS "Users can delete legal documents of accessible projects" ON public.legal_documents;
...
-- Update technical_documents policies
...
DROP POLICY IF EXISTS "Users can view technical documents of accessible projects" ON public.technical_documents;
DROP POLICY IF EXISTS "Users can create technical documents for accessible projects" ON public.technical_documents;
DROP POLICY IF EXISTS "Users can update technical documents of accessible projects" ON public.technical_documents;
DROP POLICY IF EXISTS "Users can delete technical documents of accessible projects" ON public.technical_documents;
...
-- Update project_photos policies
...
DROP POLICY IF EXISTS "Users can view photos of accessible projects" ON public.project_photos;
DROP POLICY IF EXISTS "Users can upload photos for accessible projects" ON public.project_photos;
DROP POLICY IF EXISTS "Users can delete photos of accessible projects" ON public.project_photos;
...
DROP POLICY IF EXISTS "Users can view notifications of accessible projects" ON public.notifications;
DROP POLICY IF EXISTS "Users can update notifications of accessible projects" ON public.notifications;
...
-- Update material_suppliers policies
...
DROP POLICY IF EXISTS "Users can view material suppliers of accessible projects" ON public.material_suppliers;
DROP POLICY IF EXISTS "Users can create material suppliers for accessible projects" ON public.material_suppliers;
DROP POLICY IF EXISTS "Users can update material suppliers of accessible projects" ON public.material_suppliers;
DROP POLICY IF EXISTS "Users can delete material suppliers of accessible projects" ON public.material_suppliers;
...
-- Update service_providers policies
...
DROP POLICY IF EXISTS "Users can view service providers of accessible projects" ON public.service_providers;
DROP POLICY IF EXISTS "Users can create service providers for accessible projects" ON public.service_providers;
DROP POLICY IF EXISTS "Users can update service providers of accessible projects" ON public.service_providers;
DROP POLICY IF EXISTS "Users can delete service providers of accessible projects" ON public.service_providers;
